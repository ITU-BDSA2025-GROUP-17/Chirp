...
public class AuthorService : IAuthorService
{
    ...
    public async Task FollowUser(string currentUserName, string targetUserName)
    {
        ...
        if (currentUser == null)
        {
            throw new InvalidOperationException(
                $"user with username: '{currentUserName}' doesn't exist");
        }
        ...
        {
            throw new InvalidOperationException(
                $"user with username: '{targetUserName}' doesn't exist");
        }
    ...
    public async Task<IdentityResult> DeleteAuthor(string userName)
    {
        ...
        // IdentityResult indicates success or contains a list of errors
